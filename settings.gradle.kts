...
include(":feature:selection-specializations")
include(":feature:selection-specializations:api")
include(":feature:selection-specializations:impl")
include(":mylibrary")
include(":feature:example-specializations:api")
include(":feature:example-specializations:api")
include(":feature:example-specializations:impl")
