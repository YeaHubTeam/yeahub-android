package ru.yeahub.detail_question.impl.data.mapper

import ru.yeahub.detail_question.impl.data.local.Guru
import ru.yeahub.detail_question.impl.data.local.getGuru
