...
object DeepLinkConfig {
    ...
    class DeepLinkBuilder(
        ...
        fun rootFeature(value: String): DeepLinkBuilder =
            addParameter(Parameters.ROOT_FEATURE, value)
    ...
    class DeepLinkParser(private val uri: Uri) {
        ...
        fun getRootFeature(): String =
            getParameterOrDefault(Parameters.ROOT_FEATURE, Defaults.ROOT_FEATURE)
    ...
    object Factory {
        ...
        fun custom(screenType: ScreenType): DeepLinkBuilder =
            DeepLinkBuilder(screenType = screenType)
